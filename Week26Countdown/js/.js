    ...
    let deadline = new Date("December 25, 2022 14:00:00");
    
    //Store the countdown element in a avriable and clear its text content
    let countdown = document.getElementById("countdown");
    countdown.innerHTML = "";
    
    /*
    The setCountdown function obtains the current date/time, calculates the time left between then and the deadline variable, and then converts it into days, hours, minutes, and seconds. Then it displays those values in the countdown element.
    */
